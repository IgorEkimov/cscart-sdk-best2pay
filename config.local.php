...
$config['db_name'] = 'devcscart';
$config['db_user'] = 'devcscart_user';
$config['db_password'] = 'WtVIu*AHodV819X6';
...
$config['http_host'] = 'devcscart.ru';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'devcscart.ru';
$config['https_path'] = '';
